...
export default function ChatsMain({ selectedRoom }) {
  ...
  return (
    <div className="chat-display" style={{ width: "78%" }}>
      ...
      {/* Messages Container */}
      <div className="messages-container"  ref={messagesContainerRef} style={{ maxHeight: "60vh", overflowY: "auto", padding: "5px", display: "flex", flexDirection: "column" }}>
        {messages
          ...
          .map((msg, index) => (
            <div
              ...
              style={{
                ...
                borderRadius: "10px",
                marginBottom: "10px",
                alignSelf: msg.name === student.name ? "flex-start" : "flex-end",
                backgroundColor: msg.name === student.name ? "#000000" : "#e8e6e6",
                color: msg.name === student.name ? "#ffffff" : "#000000",
              }}
            >
              {msg.content}
              <br />
      ...
      <div className="message-input-container" style={{ display: "flex", padding: "10px", borderTop: "1px solid gray" }}>
        <input
          type="text"
          value={newMessage}
